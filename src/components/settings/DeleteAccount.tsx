export default function DeleteAccount(props: {isVisible : boolean}){
  if(props.isVisible){
    return (
        ...
        <div className="flex flex-col justify-around items-stretch h-[100%]">
          <center>
            <div className="w-[280px] h-[300px] rounded-[16px] p-[24px] bg-[#FFFFFF]">
              ...
              <div>
                <button className="border-[1px] border-[#201E1D66] font-[14px] text-[#2A1F1C] font-[800] w-[112px] h-[39px] rounded-[9px] bg-[#FFF] mr-[8px]">취소</button>
                <button className="font-[14px] text-[#FFF] font-[800] w-[112px] h-[39px] rounded-[9px] bg-[#E5342A]">탈퇴하기</button>
              </div>
            </div>
          </center>
        </div>
