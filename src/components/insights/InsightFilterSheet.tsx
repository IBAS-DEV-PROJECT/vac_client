...
function cloneFilters(f: InsightFilters): InsightFilters {
  return { ...f, topics: [...f.topics], values: [...f.values] }
}
...
function InsightFilterSheet({
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex flex-col justify-end">
      ...
      <div className="relative flex max-h-[80vh] flex-col rounded-t-3xl bg-[#E1F5FE]">
        {/* 헤더 */}
        ...
        <div className="px-5 pb-6 pt-4">
          <Button
            onClick={handleApply}
            disabled={
              pending.topics.length === 0 || pending.values.length === 0
            }
          >
            적용하기
          </Button>
